        ...
        <main className="flex-1 bg-school-secondary">
            ...
            <div>
                <div className="text-center py-12">
                    <h2 className="text-4xl font-bold tracking-tight text-red-800 uppercase sm:text-5xl">Our History,
                ...
                <div className="space-y-16">
                    <div className="flex flex-col-reverse md:flex-row gap-8 lg:gap-12 px-6 items-center">
                        <div className="md:w-2/3 md:p-6">
                            <h3 className="text-2xl md:text-4xl font-bold tracking-tight text-red-800 uppercase text-center md:text-left">A
                                Legacy of
                                Excellence</h3>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 lg:gap-12 items-center bg-red-800 py-16 px-6">
                        ...
                        <div className="md:w-2/3 md:p-6">
                            ...
                            <p className="mt-4 text-lg text-gray-50">
                                ...
                                B.Vinod ensures every student thrives in an environment of limitless
                                possibilities..<br/>
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div className="md:w-2/3 md:p-6">
                            ...
                            <p className="mt-4 text-lg text-gray-50">
                                Discover our dynamic curriculum design to inspire curiosity, critical thinking, and
